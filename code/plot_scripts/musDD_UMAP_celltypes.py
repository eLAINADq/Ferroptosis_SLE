...
from common import MUSDD_CELLTYPE_ORDER, CELLTYPE_PALETTE, add_umap_arrows, ordered_present, plt, read_source, save_figure, set_umap_limits


FIGURE_NAME = Path(__file__).stem
ORDER = MUSDD_CELLTYPE_ORDER
MIN_LABEL_CELLS = 80
